...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		...
		'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label><textarea id="comment" placeholder="Enter your comment here." name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',
